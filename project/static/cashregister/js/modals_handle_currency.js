 ...
 * y tenemos una variable categoryID que no esta siendo usada pero esta para futuras peticiones AJAX
 */
	...
	document.addEventListener("DOMContentLoaded", () => {
		...
		const confirmButton = document.querySelector(
			"#delete-currency-modal .btn-danger"
		);
	
		deleteButtons.forEach((button) => {
			button.addEventListener("click", function () {
				const currencyId = this.getAttribute("data-id"); // para usar en un futuro
