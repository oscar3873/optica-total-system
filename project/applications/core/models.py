...
class Person(SoftDeletionModel, TimestampsModel):
    ...
    phone_code = models.CharField(max_length=10, blank=True, null=True,verbose_name="Codigo del país")
    phone_number = models.PositiveBigIntegerField(null=True, blank=True,verbose_name="Número de telefono")
    dni = models.CharField(max_length=20, db_index=True, null=True, blank=False)
    birth_date = models.DateField(null=True, blank=True,verbose_name="Fecha de nacimiento")
    address = models.CharField(max_length=120, blank=True, null=True,verbose_name="Direccion")
