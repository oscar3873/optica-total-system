...
class Promotion(BaseAbstractWithUser): # promocion de 2 products
    ...
    name = models.CharField(max_length=100, verbose_name='Nombre de la Promocion', null=True, blank=True) # Promo "Verano", "Friday", "Hotsale"
    ...
    description = models.CharField(max_length=250, verbose_name='Descripcion', null=True, blank=True)
